...
def run_experiment_gn(num_r_units, map_number, block_size, random_seed, total_steps):

    # Make save files
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    save_assignment_results_to = f"/share/duchin/raina/final exp results/syn exp results/GN/r_votes_{num_r_units}_map_{map_number}/{block_size}/{total_steps}_{current_time}_assignment.jsonl.ben"
    save_updaters_results_to = f"/share/duchin/raina/final exp results/syn exp results/GN/r_votes_{num_r_units}_map_{map_number}/{block_size}/{total_steps}_{current_time}_updaters.jsonl"
